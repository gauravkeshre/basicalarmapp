...
//#define _DATE_COMPONENTS (NSCalendarUnitYear| NSMonthCalendarUnit | NSCalendarUnitDay | NSWeekCalendarUnit |  NSHourCalendarUnit | NSMinuteCalendarUnit | NSSecondCalendarUnit | NSWeekdayCalendarUnit | NSWeekdayOrdinalCalendarUnit)
...
+(NSDateFormatter *)dateFormatterForUTC{
   ...
   //deepankar....
        /*
         * set the locale here as in iOS-7 & above calling dateFromString will return nil...
         */
...
- (BOOL) isSameWeekAsDate: (NSDate *) aDate
{
	...
	return !((fabs([self timeIntervalSinceDate:aDate]) < D_WEEK)<1);
}
